...
CREATE TABLE `cart_items` (
  ...
  CONSTRAINT `cart_items_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`sku`)
...
INSERT INTO `products` VALUES (1,30,5,NULL),(2,40,3,NULL),(3,40,3,NULL);
...
-- Dump completed on 2024-06-20  1:20:15
